export class Ammo {
    ...
    public one_two_seven_zero_uncommon = [
    ...
    public one_two_seven_zero_rare = [
    ...
    // 20/70 Ammo
    public two_zero_seven_zero_common = [
    ...
    public two_zero_seven_zero_uncommon = [
